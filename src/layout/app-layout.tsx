...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Invitation', path: '/invitations', entity: 'invitation', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Report', path: '/reports', entity: 'report', service: AccessServiceEnum.PROJECT, icon: FiBox },
